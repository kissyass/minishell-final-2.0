...
SRCS	=	main.c utils.c env/set_env.c env/env.c cmd/close.c cmd/cmd.c cmd/run_cmd.c \
			...
			builtin/builtin.c builtin/echo.c builtin/cd_pwd.c builtin/export.c builtin/export_utils.c builtin/unset.c builtin/input_output.c builtin/utils.c pipes/pipes.c
OBJS = $(SRCS:.c=.o)
LIBFT       = libft.a
LIBFT_DIR := libft
